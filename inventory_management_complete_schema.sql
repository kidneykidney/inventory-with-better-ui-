...
\restrict KDLquT49DPJBwWV7fCxGRcupQQqRSxbKkhOHPLJKqVbHhBaHqOiiy46jaAmoKAB

-- Dumped from database version 17.6
-- Dumped by pg_dump version 17.6

-- Started on 2025-09-11 09:57:33
...
ALTER TABLE IF EXISTS ONLY public.student_acknowledgments DROP CONSTRAINT IF EXISTS student_acknowledgments_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.student_acknowledgments DROP CONSTRAINT IF EXISTS student_acknowledgments_invoice_id_fkey;
ALTER TABLE IF EXISTS ONLY public.products DROP CONSTRAINT IF EXISTS products_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.product_transactions DROP CONSTRAINT IF EXISTS product_transactions_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.order_items DROP CONSTRAINT IF EXISTS order_items_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.order_items DROP CONSTRAINT IF EXISTS order_items_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoices DROP CONSTRAINT IF EXISTS invoices_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoices DROP CONSTRAINT IF EXISTS invoices_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoice_transactions DROP CONSTRAINT IF EXISTS invoice_transactions_invoice_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoice_items DROP CONSTRAINT IF EXISTS invoice_items_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoice_items DROP CONSTRAINT IF EXISTS invoice_items_order_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoice_items DROP CONSTRAINT IF EXISTS invoice_items_invoice_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoice_images DROP CONSTRAINT IF EXISTS invoice_images_invoice_id_fkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_user_id_fkey;
DROP TRIGGER IF EXISTS update_students_updated_at ON public.students;
DROP TRIGGER IF EXISTS update_products_updated_at ON public.products;
DROP TRIGGER IF EXISTS update_product_quantity_trigger ON public.order_items;
...
DROP TRIGGER IF EXISTS create_lending_invoice_trigger ON public.orders;
DROP INDEX IF EXISTS public.students_student_id_unique_when_not_empty;
DROP INDEX IF EXISTS public.students_email_unique_when_not_empty;
DROP INDEX IF EXISTS public.idx_students_student_id_flexible;
DROP INDEX IF EXISTS public.idx_students_student_id;
DROP INDEX IF EXISTS public.idx_students_email_flexible;
DROP INDEX IF EXISTS public.idx_students_email;
DROP INDEX IF EXISTS public.idx_student_acknowledgments_invoice_id;
...
DROP INDEX IF EXISTS public.idx_product_transactions_product_id;
DROP INDEX IF EXISTS public.idx_orders_student_id;
...
DROP INDEX IF EXISTS public.idx_invoices_student_id;
DROP INDEX IF EXISTS public.idx_invoices_status;
DROP INDEX IF EXISTS public.idx_invoices_order_id;
DROP INDEX IF EXISTS public.idx_invoices_issue_date;
DROP INDEX IF EXISTS public.idx_invoices_invoice_number;
DROP INDEX IF EXISTS public.idx_invoice_transactions_invoice_id;
DROP INDEX IF EXISTS public.idx_invoice_items_product_id;
DROP INDEX IF EXISTS public.idx_invoice_items_invoice_id;
DROP INDEX IF EXISTS public.idx_invoice_images_invoice_id;
DROP INDEX IF EXISTS public.idx_invoice_images_image_type;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_username_key;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_key;
ALTER TABLE IF EXISTS ONLY public.user_sessions DROP CONSTRAINT IF EXISTS user_sessions_refresh_token_jti_key;
ALTER TABLE IF EXISTS ONLY public.user_sessions DROP CONSTRAINT IF EXISTS user_sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.user_sessions DROP CONSTRAINT IF EXISTS user_sessions_access_token_jti_key;
ALTER TABLE IF EXISTS ONLY public.system_settings DROP CONSTRAINT IF EXISTS system_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.system_settings DROP CONSTRAINT IF EXISTS system_settings_category_key_key;
ALTER TABLE IF EXISTS ONLY public.students DROP CONSTRAINT IF EXISTS students_pkey;
ALTER TABLE IF EXISTS ONLY public.student_acknowledgments DROP CONSTRAINT IF EXISTS student_acknowledgments_pkey;
ALTER TABLE IF EXISTS ONLY public.products DROP CONSTRAINT IF EXISTS products_sku_key;
ALTER TABLE IF EXISTS ONLY public.products DROP CONSTRAINT IF EXISTS products_pkey;
ALTER TABLE IF EXISTS ONLY public.product_transactions DROP CONSTRAINT IF EXISTS product_transactions_pkey;
...
ALTER TABLE IF EXISTS ONLY public.invoice_transactions DROP CONSTRAINT IF EXISTS invoice_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.invoice_items DROP CONSTRAINT IF EXISTS invoice_items_pkey;
ALTER TABLE IF EXISTS ONLY public.invoice_images DROP CONSTRAINT IF EXISTS invoice_images_pkey;
...
DROP VIEW IF EXISTS public.students_unique;
DROP VIEW IF EXISTS public.students_clean;
DROP TABLE IF EXISTS public.products;
DROP TABLE IF EXISTS public.product_transactions;
DROP TABLE IF EXISTS public.order_items;
DROP TABLE IF EXISTS public.notifications;
DROP TABLE IF EXISTS public.invoice_transactions;
DROP VIEW IF EXISTS public.invoice_details;
DROP TABLE IF EXISTS public.students;
DROP TABLE IF EXISTS public.student_acknowledgments;
DROP TABLE IF EXISTS public.orders;
DROP TABLE IF EXISTS public.invoices;
DROP TABLE IF EXISTS public.invoice_items;
DROP TABLE IF EXISTS public.invoice_images;
...
DROP FUNCTION IF EXISTS public.find_or_create_student(p_student_id character varying, p_name character varying, p_email character varying, p_phone character varying, p_department character varying, p_year_of_study integer, p_course character varying);
DROP FUNCTION IF EXISTS public.create_lending_invoice();
...
-- Completed on 2025-09-11 09:57:35

--
-- PostgreSQL database dump complete
--

\unrestrict KDLquT49DPJBwWV7fCxGRcupQQqRSxbKkhOHPLJKqVbHhBaHqOiiy46jaAmoKAB
