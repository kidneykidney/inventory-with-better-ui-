...
export const lightMinimalTheme = createTheme({
  ...
  shadows: [
    ...
    '0 27px 54px rgba(0, 0, 0, 0.08)',
    '0 28px 56px rgba(0, 0, 0, 0.08)',
    '0 29px 58px rgba(0, 0, 0, 0.08)',
    '0 30px 60px rgba(0, 0, 0, 0.08)',
    '0 31px 62px rgba(0, 0, 0, 0.08)',
    '0 32px 64px rgba(0, 0, 0, 0.08)',
    '0 33px 66px rgba(0, 0, 0, 0.08)',
    '0 34px 68px rgba(0, 0, 0, 0.08)',
    '0 35px 70px rgba(0, 0, 0, 0.08)',
    '0 36px 72px rgba(0, 0, 0, 0.08)',
    '0 37px 74px rgba(0, 0, 0, 0.08)',
  ],
  components: {
    MuiCssBaseline: {
      styleOverrides: {
